...
//    private ArrayList aL;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //akses Db
        mDb.getReference().child("bagas").addValueEventListener(new ValueEventListener() {
            //ngakses child
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                txtWater1.setText(String.valueOf(dataSnapshot.child("water").getValue()));
...
//            axisYValues.add(new AxisValue(3).setLabel("300").setValue(300));
        Axis axisY = new Axis(axisYValues).setName("Axis Y").setHasLines(true);
